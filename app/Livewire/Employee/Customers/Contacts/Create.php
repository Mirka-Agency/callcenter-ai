...
class Create extends Component
{
    ...
    {
        try {
            $customer = $updater->create(EmployeeContext::membership()->organization_id, [
                'name' => $this->name,
        ...
        $this->redirect(route('employee.customers.show', $customer), navigate: true);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.shared.customers.create', [
            'backRoute' => route('employee.customers.contacts.index'),
